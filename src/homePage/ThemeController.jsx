...
const ThemeController = () => {
    ...
    const {isDark,setIsDark, toggle} = useContext(themeContext)
  ...
  return (
    <div className="my-4 flex justify-center items-center">
      <button
        onClick={toggle}
        className="button size-10 flex items-center justify-center  dark:text-yellow dark:border-yellow  dark:active:bg-yellow dark:active:text-black"
      >
        {isDark ? (
          <svg
